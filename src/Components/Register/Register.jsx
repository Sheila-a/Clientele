...
// import BG from "../../Images/doctorbg.png";
    ...
    <div>
      ...
      <div className="Reg">
        <div className="reg-left">
          {/* <img src={BG} alt="" className="reg-img" /> */}
        </div>
        ...
        <div className="reg-right">
          <div className="Reg-text">
            ...
            <p>
              ...
              numquam consectetur laborum facere dolores reprehenderit
              laboriosam? Labore, perferendis? Voluptatibus.
            </p>
            ...
            <div className="Reg-form">
              <form action="">
                ...
                <div className="reg-radio">
                  <h4>Taking any medications currently ?</h4>
                  <div>
                    <input type="radio" />
                    Yes
                ...
                <div>
                  <input type="checkbox" name="" id="" />I accept the Terms of
                  Use & Privacy Policy.
                </div>
                <br />
