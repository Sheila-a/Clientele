  ...
  return (
    <div className="Biodata">
      ...
      <div className="NavChild whiter">
        ...
        <h2 className="NavChild1">MERIEN</h2>
        <div className="NavChild11">
          ...
          {/* <p className="NavChildList">
            <Link to="/our-services">Covid-19 Policy</Link>
          </p> */}
          <p className="NavChildList NCL">
      ...
      <div className="biodata">
        <h2 className="biodata-title">Please fill the form below</h2>
        <form action="" className="biodata-form">
          <h3>Firstname</h3>
          <input type="text" className="datainput" required />
          <h3>Lastname</h3>
          <input type="text" className="datainput" required />
          <h3>Age</h3>
          <input type="text" className="datainput" required />
          ...
          <div className="iguess">
            <div className="Nationality">
              <h3>Nationality</h3>
              <select id="country" name="country" className="datainput DI">
            ...
            <div className="State">
              <h3>State </h3>
              <select name="state" id="state" className="datainput DI">
                <option value="" selected="selected">
                  - Select -
                </option>
          ...
          <div>
            <button className="biodata-btn">Submit</button>
          </div>
        </form>
      </div>
      <div class="area">
