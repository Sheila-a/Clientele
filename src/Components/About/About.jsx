    ...
    <div className="ABT">
        ...
        <div className="ABT-left">
          <div className="ABT-bg">
            <div className="ABT-left-text">
              <h1>Our Amazing Doctors</h1>
              <p className="MD-text">
                We have the best Doctors there is. We supply the best service to
                our patients.
              </p>
              <br />
              <p className="MD-text">
      ...
      <div className="ABT-DOC">
        <div className="ABT-DOC-right">
          ...
          <h3 className="ABT-texts">CMD, Merien Hospitals</h3>
      ...
      <div className="ABT-MS">Our Staff</div>
      <div className="ABT-MD">
        <div className="ABT-right">svsv</div>
        <div className="ABT-left">
          <div className="ABT-bg flip"></div>
        </div>
      </div>
    </div>
  );
