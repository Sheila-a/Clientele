...
const PTherapy = () => {
  return (
    <div>
      <Navbar />
      <div className="ptherapy">
        <br />
        <br />
        <h1 className="ptherapy-mega-title">PHYSICAL THERAPY</h1>
        <br />
        <br />
        <br />
        <div className="ptherapy-origin">
          <h2 className="ptherapy-title">THERAPY 1</h2>
          <br />
          <p className="ptherapy-text">
        ...
        <br />
        <br />
        <div className="ptherapy-origin-1">
          <h2 className="ptherapy-title">THERAPY 2</h2>
          <br />
          <p className="ptherapy-text">
        ...
        <br />
        <br />
        <div className="ptherapy-origin-2">
          <h2 className="ptherapy-title">THERAPY 3</h2>
          <br />
          <p className="ptherapy-text">
        ...
        <br />
        <br />
        <div className="ptherapy-origin-3">
          <h2 className="ptherapy-title">THERAPY 4</h2>
          <br />
          <p className="ptherapy-text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
            inventore, expedita excepturi eveniet voluptates explicabo ex autem?
